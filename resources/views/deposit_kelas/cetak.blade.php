                ...
                <div class="col-12 col-lg-12">
                    ...
                    <div class="mt-4">
                        <div>
                            ...
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">Deposit ({{ $data->nama_paket }})</div>
                                <div class="col-9">:Rp. {{ MyHelper::nf($data->jumlah) }} ,-({{ $data->sesi }}xRp. {{ MyHelper::nf($data->harga1) }})</div>
                            </div>
    
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">Jenis kelas</div>
                                <div class="col-9">:{{ $data->jenis_kelas }}</div>
                            </div>
    
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">Total Deposit {{ $data->jenis_kelas }}</div>
                                <div class="col-9">:{{ ($data->sesi+$data->gratis) }}</div>
                            </div>
    
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">Berlaku sampai dengan</div>
