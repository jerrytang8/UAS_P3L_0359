                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="text-black-m2">
                                <div class="my-1"><i class="fa fa-phone fa-flip-horizontal"></i> <b
                                        class="text-600">GoFit</b></div>
                                <div class="my-1">
                    ...
                    <div class="mt-4">
                        <div>
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3 text-600">STRUK PRESENSI KELAS PAKET</div>
                                <div class="col-9"></div>
                            </div>

                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">No Struk</div>
                                <div class="col-9">: {{ $data->no_struk }}</div>
                            </div>
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">Tanggal</div>
                                <div class="col-9">: {{ MyHelper::tglstruk($data->tanggal) }}</div>
                            </div>

                            <div class="row mb-2 mb-sm-0 py-10 mt-4">
                                <div class="d-none d-sm-block col-3 text-600">Member</div>
                                <div class="col-9">: {{ $data->member }}/{{ $data->nama_member }}</div>
                            </div>

                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">Kelas</div>
                                <div class="col-9">: {{ $data->kelas }}</div>
                            </div>
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">Instruktur</div>
                                <div class="col-9">: {{ $data->ins1 }}</div>
                            </div>
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">Sisa Deposit</div>
                                <div class="col-9">: {{ $data->sisa_deposit }}x</div>
                            </div>
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">Berlaku Sampai</div>
                                <div class="col-9">: {{ MyHelper::masa_aktif($data->masa_aktif_member) }}</div>
                            </div>
