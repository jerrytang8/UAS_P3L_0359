                    ...
                    <div class="mt-4">
                        <div>
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3 text-600">STRUK PRESENSI KELAS</div>
                                <div class="col-9"></div>
                            </div>
                            ...
                            <div class="row mb-2 mb-sm-0 py-10">
                                <div class="d-none d-sm-block col-3">Tarif</div>
                                <div class="col-9">: Rp. {{ MyHelper::nf($data->harga) }}</div>
                            </div>
                            <div class="row mb-2 mb-sm-0 py-10">
