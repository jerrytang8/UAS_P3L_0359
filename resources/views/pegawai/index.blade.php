                    ...
                    <div class="card">
                        <div class="card-header d-sm-flex d-block pb-0 border-0">
                            ...
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#tambah"
                                ...
                                <i class="fa fa-plus scale5 mr-3"></i>Tambah Pegawai
                            </a>
                        </div>
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ url('/pegawai/tambah') }}" method="POST">
                                            @csrf
                                                            ...
                                                            <form action="{{ url("/pegawai/$i->id") }}" method="POST"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="alamat"
                                                                        value="{{ $i->alamat }}" class="form-control"
                                                                        required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Telepon</label>
                                                                    <input type="number" name="telepon"
                                                                        value="{{ $i->telepon }}" class="form-control"
                                                                        required>
                                                                </div>
                                                                <button class="btn btn-primary">Submit</button>
                                                            </form>
